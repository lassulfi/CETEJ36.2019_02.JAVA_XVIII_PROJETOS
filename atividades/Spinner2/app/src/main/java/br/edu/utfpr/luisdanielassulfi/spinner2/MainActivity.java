package br.edu.utfpr.luisdanielassulfi.spinner2;
...
public class MainActivity extends AppCompatActivity {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(marca.equals(getString(R.string.ford))) {
                    ...
                    Toast.makeText(MainActivity.this,
                            R.string.nenhum_modelo_para_marca, Toast.LENGTH_SHORT).show();
                }
            }
    ...
    private void popularModelos(int arrayId) {
        ArrayAdapter<CharSequence> adapter = ArrayAdapter
                .createFromResource(this, arrayId, android.R.layout.simple_spinner_item);
